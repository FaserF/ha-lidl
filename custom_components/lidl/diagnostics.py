"""Diagnostics support for Lidl weekly offers."""
...
async def async_get_config_entry_diagnostics(
    ...
    diagnostics_data = {
        ...
        "coordinator": {
            "store_key": coordinator.store_key,
            ...
            "offers_count": len(coordinator.data.get("offers", []))
            if coordinator.data
            else 0,
            "preview_offers_count": len(coordinator.data.get("preview_offers", []))
            if coordinator.data
            else 0,
        },
    }
