# AI Agent Reference for ha-lidl
...
| Area | Path |
|---|---|
| Integration Entry | `custom_components/lidl/__init__.py` |
| Coordinator | `custom_components/lidl/coordinator.py` |
| Options Flow | `custom_components/lidl/config_flow.py` |
| Tests | `tests/` |
